...
from .user_department import UserDepartment, UserDepartmentCreate, UserDepartmentUpdate
...
from .user_position import UserPosition, UserPositionCreate, UserPositionUpdate
