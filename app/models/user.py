...
class User(Base):
    ...
    user_companies = relationship("UserCompany", back_populates="users", viewonly=True)
    user_departments = relationship("UserDepartment", back_populates="users", viewonly=True)
    user_employments = relationship("UserEmployment", back_populates="users", viewonly=True)
    user_positions = relationship("UserPosition", back_populates="users", viewonly=True)
    ...
    positions = relationship("Position", secondary="userposition", back_populates="users")
